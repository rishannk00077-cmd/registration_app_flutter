...
Future<void> register(String Username,String Email,String Password,String ConfirmPassword,BuildContext context)async{
try{
  UserCredential userCredential=await FirebaseAuth.instance.createUserWithEmailAndPassword(email: Email, password: Password);
  await FirebaseFirestore.instance.collection("users").doc(userCredential.user!.uid).set({"NAME":Username,"EMAIL":Email});
